...
"""
This file contains a qudi hardware module to interface with Stanford Research Instruments SR830 Lock-In Amplifier

Mitchell O. de Vries, 2025
...
class SR830_lockin(DataInStreamInterface):
